...
**M4 —— 主体完成**（网络 AI 接入 GUI；RL 闭环收敛实证；M5 回放已实现）
...
- [x] M4 验证+长训 12 迭代：loss 6.59→2.43（-63%），评估门采纳 4 次
- [x] M4 棋力验收：vs 随机 100% ✅ / vs 纯 MCTS 83.3% ✅ / vs 贪心 0%（需长训）
- [x] M5 对局回放（主菜单 7，自动保存对局记录）
- [ ] M4 持续长训（2–5 天 GPU 达成最终棋力）+ M5 人工验收/打包
